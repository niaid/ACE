...
Annotations (gene models) can come from different sources.  We’ll use a pre-packaged source here; a later exercise/example retrieves  similar  information from a GFF file.  We will install the package first, then load it into memory.
