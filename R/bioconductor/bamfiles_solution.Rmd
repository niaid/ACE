...
3. Use `alphabetByCycle` to summarize nucleotide use by cycle; plot the relationship between cycle and use. Might be a little tricky!  Try examining the `res` object.  Were you expecting this? What is going on?
```{r}
library(magrittr)
library(tidyr)
library(ggplot2)
